...
if("TRUE" STREQUAL "TRUE")
  set(panda_simulation_SOURCE_PREFIX /home/eugeniomonari/catkin_ws/src/panda_simulation)
  set(panda_simulation_DEVEL_PREFIX /home/eugeniomonari/catkin_ws/devel)
  ...
  set(panda_simulation_INSTALL_PREFIX /home/eugeniomonari/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'panda_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eugeniomonari/catkin_ws/src/panda_simulation/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND panda_simulation_EXPORTED_TARGETS ${${panda_simulation_dep}_EXPORTED_TARGETS})
endforeach()
